...
# 10. Declare ARG again for production stage
ARG NEXT_PUBLIC_SERVER_URI
ARG NEXT_PUBLIC_NEXTAUTH_URL
ARG NEXTAUTH_URL
ARG NEXT_PUBLIC_KAKAO_CLIENT_ID
...
# 11. Environment variable for production
...
ENV NEXT_PUBLIC_COOKIEPAY_API_ID=$NEXT_PUBLIC_COOKIEPAY_API_ID
ENV COOKIEPAY_API_ID=$COOKIEPAY_API_ID
ENV COOKIEPAY_API_KEY=$COOKIEPAY_API_KEY
ENV COOKIEPAY_MODE=$COOKIEPAY_MODE
ENV COOKIEPAY_BASE_URL=$COOKIEPAY_BASE_URL
