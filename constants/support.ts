...
export const SUPPORT_LIST: SupportItem[] = [
  ...
  },
  {
    ...
    description:
      "카페처럼 편안하게 머물면서도 공부에 집중할 수 있도록, 좌석과 콘센트 등 카공 환경을 전문적으로 갖춘 공간",
    benefits: ["일일이용권 10% 할인", "추가 제휴 협의중"],
    link: "https://www.instagram.com/cagongzok_official/",
    useLink: "https://pf.kakao.com/_SaWXn/chat",
    texts: ["어바웃 멤버 및 지인 적용 가능", "어바웃 채널을 통해 구매 문의"],
  },
  {
    id: "ringle",
    name: "링글",
    ...
    coupon: {
      link: "https://link.ringleplus.com/3SpUPxf",
      code: "a5132f",
      text: "사이트 접속 → 내 정보 → 쿠폰코드 입력",
    },
    texts: [
      "어바웃 멤버 및 지인 이용 가능",
      "하단의 [제휴 혜택 받기] 버튼을 눌러 쿠폰을 받을 수 있습니다",
  ...
  },
  {
    ...
    useLink: "https://www.itbtm.com/main2/intro.php",
    texts: ["어바웃 멤버 본인만 적용 가능", "유동균 컴활 → SNS 협약 → 어바웃 멤버증 등록"],
  },

  {
    ...
    link: "https://www.itgo.co.kr/",
    coupon: {
      link: "https://www.itgo.co.kr/",
      code: "AB26K955G327",
      text: "수강권 등록 → 자유이용권 → 쿠폰코드 입력",
    },
    texts: [
      "어바웃 멤버 및 지인 이용 가능",
      "하단의 [제휴 혜택 받기] 버튼을 눌러 [자유 이용권]을 받을 수 있습니다",
      "50% 할인 쿠폰은 어바웃 채널로 별도 요청해 주세요",
    ],
  },
  {
    id: "aitgo",
  ...
  },
  {
    ...
    useLink: "https://nol.yanolja.com/ticket/products/26003518",
    texts: [
      "어바웃 멤버 본인만 적용 가능",
      "놀티켓 예매 페이지에서 재관람(제휴)으로 예매",
  ...
  },
  {
    ...
    link: "https://nol.yanolja.com/ticket/products/26003518",
    coupon: {
      link: "https://ticket.interpark.com/Contents/PartnerClosure?BizCode=63603",
      code: "FOX2026",
  ...
  },
  {
    ...
    link: "https://www.instagram.com/metacomedyclub.hongdae/",
    useLink: "https://pf.kakao.com/_SaWXn/chat",
    texts: ["어바웃 멤버 및 동반 1인 적용 가능", "어바웃 채널로 예약 문의"],
  },
  {
    ...
    useLink: "https://naver.me/GubjNRwt",
    texts: [
  ...
  },
  {
    ...
    useLink: "https://naver.me/GeUR0QwK",
    texts: [
      "어바웃 멤버만 적용 가능",
      "주말은 오후 2시까지만 적용 가능",
      "방문 후 어바웃 멤버증을 보여주면 할인 적용",
  ...
  },
  {
    ...
    useLink: "https://naver.me/GtURV3SK",
  ...
  },
  {
    ...
    link: "https://naver.me/5ZJMWu9R",
    useLink: "https://pf.kakao.com/_SaWXn/chat",
    texts: ["어바웃 멤버 및 지인 적용 가능", "어바웃 채널로 예약 문의"],
  },
  {
    id: "hook-climbing",
    name: "훅 클라이밍",
    ...
    useLink: "https://naver.me/FTXwcnAM",
    texts: ["어바웃 멤버 본인만 적용 가능", "방문 후 어바웃 멤버증을 보여주면 할인 적용"],
  },
  {
    id: "groot-climbing",
    ...
    useLink: "https://naver.me/5R4yOf2G",
    texts: ["어바웃 멤버 본인만 적용 가능", "방문 후 어바웃 멤버증을 보여주면 할인 적용"],
  },
  {
    id: "in-out",
  ...
  },
  {
    ...
    useLink: "https://safedoc.io/sign/v6n09o",
  ...
  },
  {
    ...
    useLink: "https://pf.kakao.com/_SaWXn/chat",
    texts: ["어바웃 멤버 및 지인 이용 가능", "어바웃 채널로 예약 문의"],
  },
];
