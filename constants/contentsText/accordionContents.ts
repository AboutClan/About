...
export const ACCORDION_CONTENT_FEE: IAccordionContent[] = [
  ...
  },
  {
    ...
    content:
      "공부하고 싶을 때는 매일 열리는 카공 스터디와 어학, 자격증, 취업, 자기계발, 프로그래밍 등 다양한 스터디 모임에 참여할 수 있습니다. 또한, 온라인으로 진행하는 캠 스터디와 열품타 같은 스터디 챌린지도 준비되어 있어요. 새로운 취미나 관심사를 찾고 있다면? 카페 탐방, 영화 감상, 전시회, 보드게임, 운동, 원데이 클래스 등 50여 가지의 소모임 활동을 통해 풍부한 경험을 쌓고 새로운 친구들을 만날 수 있습니다. 이 외에도 동아리 내 다양한 이벤트와 정기 모임, MT 등의 수 많은 행사가 진행되고 있습니다.",
  },
  {
