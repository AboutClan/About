    ...
    <>
      ...
      <Slide>
        ...
        <Box h="200px" p="16px" fontSize="14px">
          ...
          <br />
          <br />
          오후 11시에 결과가 발표되고, 3명 이상 있어야 오픈돼요. 하지만 오픈되지 않았더라도 걱정하지
          마세요! 오픈하지 않은 경우 &quot;자유 오픈&quot; 또는 &quot;개인 스터디&quot;로 자동으로
          전환할 수 있습니다. 출석을 완료하면 동아리 점수와 일정 확률로 알파벳도 수집할 수 있어요.
          <br />
          <br />
          같이 공부를 한 인원이 있었다면 이후에 리뷰를 보낼 수 있는 팝업이 날아와요! 이 곳에서 같이
          공부했던 인원과 친구 추가를 하거나, 좋아요를 보낼 수 있답니다!
        </Box>
      </Slide>
    </>
  );
