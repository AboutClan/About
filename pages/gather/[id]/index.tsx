...
import { useGatherParticipationMutation } from "@/features/gather/hooks/mutations";
import { useGatherIDQuery } from "@/features/gather/hooks/queries";
import GatherBottomNav from "@/features/gather/screens/detail/GatherBottomNav";
import GatherComments from "@/features/gather/screens/detail/GatherComments";
import GatherContent from "@/features/gather/screens/detail/GatherContent";
import GatherDetailInfo from "@/features/gather/screens/detail/GatherDetail";
import GatherGuide from "@/features/gather/screens/detail/GatherGuide";
import GatherHeader from "@/features/gather/screens/detail/GatherHeader";
import GatherParticipation from "@/features/gather/screens/detail/GatherParticipation";
import GatherTitle from "@/features/gather/screens/detail/GatherTitle";
...
function GatherDetail() {
  ...
  useEffect(() => {
    ...
    if (!gather || !uid || !userInfo || isMember || isLoading || userInfo?.role === "guest") return;
