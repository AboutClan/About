...
import { useUserRegisterFormsQuery, useUserRequestQuery } from "../../../hooks/admin/quries";
...
function AdminRegister() {
  ...
  const { data, isLoading } = useUserRequestQuery("지원금");

  const A = data?.map((props) => props.content.split("/"));
