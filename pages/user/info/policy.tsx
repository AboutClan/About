      ...
      <Slide>
        <Container maxW="container.md" py={4}>
          ...
          <List styleType="number" ml="1em">
            ...
            <ListItem>
              &quot;포인트&quot;란 출석, 스터디·모임 참여, 친구 초대, 이벤트 참여 등 활동에 따라
              적립되거나, 회원이 유상으로 구매(충전)할 수 있는 서비스 전용 디지털 재화로서, About가
              정한 기준에 따라 모임 불참 시 차감되거나 스토어 내 기프티콘 등 상품·서비스 구매에
              사용할 수 있는 단위를 말합니다.
            </ListItem>
            <ListItem>
          ...
          <List styleType="number" ml="1em">
            ...
            <ListItem>
              ...
              <List styleType="circle" ml="1em" mt={1}>
                ...
                <ListItem>
                  운영진의 판단에 따라 타인에 대한 존중 없이 비매너 행위를 하거나, 동아리 및
                  커뮤니티 분위기·신뢰를 저해할 우려가 있다고 판단되는 경우
                </ListItem>
                <ListItem>
          ...
          <List styleType="number" ml="1em">
            ...
            <ListItem>포인트·참여권 관리 및 활동 리워드 기능</ListItem>
          ...
          <List styleType="number" ml="1em">
            <ListItem>
              ...
              따라 적립되거나, 회원이 유상으로 구매(충전)할 수 있으며, 적립·충전·사용·소멸 기준은
              서비스 내 안내 및 공지에 따릅니다.
            </ListItem>

            <ListItem>
              포인트는 서비스 내 이용을 위해 제공되는 <b>전용 재화</b>로서, 상품 또는 서비스 이용
              과정에서 소모되는 <b>비환불성 디지털 재화</b>입니다. 이 특성으로 인해{" "}
              <b>구매 후 환불이 불가하며</b>, 현금 또는 기타 유가증권 등과 교환되지 않습니다.
            </ListItem>

            <ListItem>
              포인트는 회원 간 <b>양도, 이전, 대여, 거래가 일절 불가</b>하며, About 계정 간 합산
              또한 허용되지 않습니다.
            </ListItem>

            <ListItem>
              구매한 포인트의 유효기간은 충전일로부터 1년이며, 기간 내 미사용 포인트는 자동
              소멸됩니다. 소멸 예정 포인트는 서비스 내 별도 고지를 통해 안내할 수 있습니다.
            </ListItem>
            ...
            <ListItem>
              회원은 About가 운영하는 스토어에서 기프티콘 등 About가 지정한 상품·서비스를 포인트로
              구매할 수 있으며, 포인트 사용 후에는 관련 정책에 따라 취소 또는 환불이 제한될 수
              있습니다.
            </ListItem>
          </List>
          ...
          <Heading as="h3" fontSize="lg" mt={3}>
            제14조(모임 불참에 따른 포인트 차감)
          </Heading>
          <List styleType="number" ml="1em">
            <ListItem>
              회원이 신청한 모임에 정해진 시간까지 참여하지 않거나, 서비스 내에서 정한 기준에 따른
              불참(당일 취소, 노쇼 등)으로 처리되는 경우, 노쇼 방지 및 안정적인 운영을 위하여 서비스
              내 정책에 따라 일정 포인트(기본 2,000P)가 차감될 수 있습니다.
            </ListItem>
            <ListItem>
              전항에 따른 포인트 차감은 모임 불참에 대한 패널티로서, 사전에 예치되는 보증금이 아니며
              회원 간 금전 거래 또는 정산에 해당하지 않습니다.
            </ListItem>
            <ListItem>
              불참 기준, 차감 포인트 및 예외 사유(About의 귀책사유로 인한 모임 취소 등)에 관한
              세부사항은 서비스 내 별도 안내에 따릅니다.
            </ListItem>
          </List>
