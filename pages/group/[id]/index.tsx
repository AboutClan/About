...
export type GroupContentCategory = "정보" | "모임" | "피드" | "출석부" | "채팅";
...
function GroupDetail() {
  ...
  const [category, setCategory] = useState<GroupContentCategory>("정보");
  ...
  return (
    <>
      ...
      {category === "피드" && <WritingIcon url={`/group/writing/feed/${id}`} />}
    </>
  );
}
