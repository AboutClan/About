...
// 스마트 앱 다운로드 리디렉션: 리트리 등록용 단일 진입점 (https://about20s.club/download/app)
...
const PC_FALLBACK_URL = "https://study-about.club";
...
function AppDownloadRedirectPage() {
  return (
    <>
      <Head>
...
export default AppDownloadRedirectPage;
