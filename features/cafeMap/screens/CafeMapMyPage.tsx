...
import CafeMapSecedeModal from "@/features/cafeMap/modals/CafeMapSecedeModal";
import { useMyPlaceFavoritesQuery } from "@/features/study/hooks/queries";
import { CafeCompactCard } from "@/features/studyMap/components/CafeListDrawer";
...
import UserProfileBar from "@/features/user/screens/UserProfileBar";
  ...
  return (
    <>
      <Box
        ...
        left={0}
        right={0}
        bottom={`calc(52px + ${getSafeAreaBottom(0)})`}
        overflowY="auto"
        bg="white"
        maxW="var(--max-width)"
        mx="auto"
