...
const theme = extendTheme({
  ...
  colors: {
    ...
    green: {
      50: "#edf7ed", // 연한 초록색 (red의 50단계와 유사한 명도)
      100: "#d2ecd2", // 연한 초록색
      200: "#a8dba8", // 밝은 초록색 (yellow의 200단계와 유사)
      300: "#78c978", // 중간 초록색 (blue의 300단계와 유사)
      400: "#4db84d", // 선명한 초록색
      500: "#2e9d2e", // 메인 초록색 (다른 팔레트 500단계와 비슷한 명도)
      600: "#258025", // 약간 어두운 초록색
      700: "#1d651d", // 더 어두운 초록색
      800: "#154915", // 깊은 초록색
      900: "#0c2e0c", // 가장 어두운 초록색 (blue 900과 유사)
    },
    teal: {
