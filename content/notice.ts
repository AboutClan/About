...
export type NoticeCategory = "공지" | "기타" | "행사" | "업데이트";
...
export const NOTICE_ARR: INoticeArr[] = [
  ...
  //   category: "update",
  //   content:
  //     "동아리 어플이 출시되었습니다! 저희 사이트에 접속한 후 모바일에서 '홈 화면에 추가' 버튼을 찾아 누르시면 앱으로 설치가 되는데요! 1차 출시일은 6월 2일이라 아직 추가 될 부분들이 있어서 이후 서비스 가이드 영상과 함께 공지할 수 있도록 하겠습니다.",
  //   date: "2024-05-31",
  // },
  // {
  //   id: "94",
  ...
  //   category: "sub",
  //   content:
  //     "체계 변경으로 기존 점수가 리셋되었습니다. 리셋 보상으로 모든 인원에게 +20 POINT와 상위권 10명에게는 유니크 배지가 지급됩니다.",
  //   date: "2024-06-05",
  // },
  // {
  //   id: "95",
  ...
  // {
  //   id: "96",
  //   title: "랭킹페이지 리뉴얼 기념 이벤트",
  //   category: "event",
  //   content:
  //     "랭킹페이지가 리뉴얼 됐습니다. 기념으로 이번 6월 달이 끝나는 시점에 활동 랭킹 30위 안에 드시는 분들 중 랜덤으로 세분께 기프티콘을 드립니다!",
  //   date: "2024-06-09",
  // },
  // {
  //   id: "97",
  ...
  //   category: "event",
  //   content:
  //     "시험 기간 동안 소소하게 디스코드 스터디를 운영합니다. 스터디 참여할 때는 손캠도 좋고, 책상만 나와도 되고, 화면 공유를 해도 되고 어떤 방식이든 공부중인 것만 알 수 있으면 상관없어요! 상세 내용은 단톡방에 공지하겠습니다.",
  //   date: "2024-06-12",
  // },
  // {
  //   id: "98",
  ...
  //   category: "update",
  //   content:
  //     "웹사이트가 한번 더 리뉴얼 됐어요! 6월 말에 커뮤니티 게시판을 마지막으로 최종 서비스가 완성될 예정입니다!",
  //   date: "2024-06-19",
  // },
  // {
  //   id: "99",
  //   title: "다양한 분야의 능력자 모집",
  //   category: "sub",
  //   content:
  //     "서비스 운영에 필요한 여러 분야의 능력자를 모집합니다! 마케팅, 서비스 운영, UI/UX 피드백, 디자인(캐릭터, 배너 제작) 등을 전공하고 재능을 사용하고자 하는 인원! 당연히 열정 페이, 재능 기부 아니고 합당한 외주 비용을 지급합니다. (상세 내용은 톡방 확인)",
  //   date: "2024-06-19",
  // },
  // {
  //   id: "100",
  ...
  //   category: "main",
  //   content:
  //     "자격증 준비, 영어 공부, 자기계발 등을 포함해 카페 탐방, 연극 관람, 보드게임 등의 모든 분야로 소그룹이 개설될 수 있습니다. 모임을 개설한 그룹장에게는 최소 5000원에서 최대 3만원의 지원금이 개인 사비로 지급됩니다. 동아리원 또한 원하는 모임에 참여할 수 있습니다.",
  //   date: "2024-06-19",
  // },
  // {
  //   id: "101",
  //   title: "20여개의 다양한 소모임 개설 !!",
  //   category: "main",
  //   content:
  //     "총 20여개의 다양한 소모임이 개설되었습니다! 상세 내용은 공지 톡방 또는 노션에서 확인해주세요! 시작일은 7월 8일입니다.",
  //   date: "2024-07-01",
  // },
  // {
  //   id: "102",
  //   title: "번개 개설시 개인 활동비 지원!!",
  //   category: "event",
  //   content:
  ...
  //   category: "main",
  //   content:
  //     "대부분의 공지는 단톡방에서 하다보니 알림페이지를 꽤 오래 막아놨었는데, 다시 활용하도록 하겠습니다!",
  //   date: "2025-02-17",
  // },
  // {
  //   id: "116",
  //   title: "About 3차 리뉴얼 베타",
  //   category: "main",
  //   content:
  //     "상세 내용은 톡방 공지사항 확인! 2월 중은 테스트 기간으로 건의사항 및 피드백을 적극적으로 수용하겠습니다! 의견 주신 분들께는 소소한 사레까지!",
  //   date: "2025-02-17",
  // },
  // {
  //   id: "117",
  ...
  //   category: "sub",
  //   content:
  //     "동아리 점수가 초기화 되었습니다...! 오래 활동하신 분들은 아쉬움도 있겠지만, 더 많은 획득처와 콘텐츠를 제공할 수 있도록 하겠습니다.",
  //   date: "2025-02-17",
  // },
  // {
  //   id: "118",
  //   title: "📢25년 1학기 소모임 활동 안내",
  //   category: "main",
  //   content:
  //     "대부분의 소모임이 한 주간 정비을 마치고, 25년 1학기 활동을 새롭게 시작합니다. 현재 참여중이지만 1학기에 미참여 예정이신 분들은 기존 소모임 톡방만 정리해주시고, 새롭게 시작하고 싶으신 분들은 앱에서 원하는 소모임을 찾아 신청해 보세요! (정비 기간이 끝나면 마감되거나 대기 시간이 길어질 수 있어요.) 1학기에는 더욱 업그레이드 하여 다양한 콘텐츠와 소모임 행사를 진행합니다!",
  //   date: "2025-02-26",
  // },
  // {
  //   id: "119",
  //   title: "어바웃 개강 MT (가평 / 용인)",
  //   category: "sub",
  //   content:
  //     "항상 '다시 가고 싶다'는 후기가 끊이지 않는 어바웃 MT! 놓치면 1년 동안 후회각! 🚀✔ 혼자 가도 걱정 NO! 나이, 성별, 인원 등 사전 조 편성으로 자연스럽게 친해질 기회 제공 ✔ 재미 보장! 마니또, 조별 미션, MT 게임, 밤새도록 이어지는 친목 활동 ✔ 먹고 놀고 즐기자! 바비큐 파티, 캠프파이어, 보드게임, 자유 친목 타임까지!🚀상세 내용은 단톡방 공지 사항 확인!",
  //   date: "2025-03-02",
  // },
  // {
  //   id: "120",
  //   title: "🌸 About 한강 벚꽃 번개",
  //   category: "main",
  //   content:
  //     "봄바람 불면, 한강에서 만나야지! 괜히 마음이 간질거리는 따뜻한 날씨, 그냥 보내기엔 너무 아까운 토요일. 4월 5일(토), 뚝섬 한강공원에서 만나요 :)",
  //   date: "2025-03-30",
  // },
  // {
  //   id: "121",
  ...
  // {
  //   id: "122",
  //   title: "한 줄 코멘트 초기화 안내",
  //   category: "sub",
  //   content:
  //     "모든 멤버분들의 한 줄 코멘트가 랜덤으로 초기화 되었습니다. 변경을 원하시는 분은 마이페이지에서 직접 변경하시기 바랍니다.",
  //   date: "2025-04-23",
  // },
  // {
  //   id: "123",
  ...
  //   category: "event",
  //   content:
  //     "다른 멤버와 쪽지를 이용할 수 있습니다! 다만 불편한 연락으로 신고될 경우 추방될 수 있으니 유의해 주세요!",
  //   date: "2025-04-30",
  // },
  // {
  //   id: "124",
  ...
  //   category: "event",
  //   content:
  //     "커뮤니티가 다시 오픈되었습니다! 현재는 베타 버전으로 운영되며, 앞으로 익명 아바타, 채팅 등 다양한 기능이 추가될 예정입니다. 커뮤니티에서는 익명이 보장되고, 일상 이야기부터 정보 공유, 질문, 홍보까지 자유롭게 소통해보세요!",
  //   date: "2025-05-31",
  // },
  // {
  //   id: "125",
  ...
  //   category: "sub",
  //   content:
  //     "6월 1일 소셜링 온도가 산정되었습니다. 소셜링 온도는 모임 종료 후 참여자들의 익명 리뷰를 바탕으로 산정되는 멤버 후기 지표입니다. 매월 1일, 전월 15일까지의 평가가 한 번에 반영되며, 소셜링 온도가 높을수록 모임 승인률이 올라가고, 다양한 혜택을 받을 수 있습니다. 소셜링 온도 평가를 강요하거나 유도하는 경우, 추방될 수 있습니다.",
  //   date: "2025-06-01",
  // },
  // {
  //   id: "126",
  ...
  //   category: "event",
  //   content:
  //     "🔥 공부 횟수와 시간이 기록되고, 최대 적립 포인트가 높아졌으며, 스토어 가격 인하 및 포인트 출금 기능까지 추가!",
  //   date: "2025-11-17",
  // },
  // {
  //   id: "130",
  ...
  //   category: "event",
  //   content:
  //     "여러 멤버십을 통해 추가 혜택을 받을 수 있습니다. 상세 내용은 [내 정보]란을 확인해 주세요.",
  //   date: "2025-11-27",
  // },
  // {
  //   id: "131",
  ...
  //   category: "event",
  //   content:
  //     "앞으로는 [내 정보]에서 내가 참여한 스터디를 한 눈에 확인하고, 같이 참여했던 멤버들의 멤버 평가도 진행할 수 있습니다.",
  //   date: "2025-11-27",
  // },
  {
    id: "133",
  ...
  },
  {
    ...
    category: "업데이트",
    content:
      "채팅과 알림 기능을 개선해 안정적으로 소통할 수 있도록 보완했어요. 그리고 익명 커뮤니티를 본격적으로 출시했습니다. 이제 일상 공유, 질문·고민, 팀원 모집, 정보 공유, 홍보까지 모두 자유롭게 이용할 수 있으며, 모든 글은 익명이 보장됩니다. 부담 없이 가볍게 참여해보세요 🙂",
    date: "2026-03-25",
  },
  {
    id: "135",
    title: "매주 주말, 나를 위한 맞춤 모임",
    category: "행사",
    content:
      "어바웃에서 매주 [오픈 번개]를 진행합니다. [오픈 번개]는 주제도, 멤버도 내가 직접 선택해서 참여하는 신규 콘텐츠입니다. 매주 토요일에 앱에서 신청할 수 있습니다.",
    date: "2026-04-03",
  },
  {
    id: "136",
    ...
    category: "기타",
    content:
      "소셜링온도 기준 조정으로 일부 온도가 변동되었습니다. 동일인의 평가는 누적될수록 낮게 반영되며, 동아리 활동 시 온도는 상승하고 비매너·노쇼·거리두기 시 하락할 수 있습니다.",
    date: "2026-04-14",
  },
  {
    id: "137",
    ...
    category: "기타",
    content:
      "동일 인원에게 받은 평가의 점수 반영 기준을 개선하고, 장기 미활동 멤버의 소셜링 온도가 점진적으로 감소하도록 변경하였습니다.",
    date: "2026-06-04",
  },
  {
    id: "138",
    ...
    category: "업데이트",
    content:
      "이제 매칭 기준 위치를 두 곳까지 지정할 수 있습니다. 집과 회사처럼 두 곳 중 어디든 가까우면 매칭되니, 갈 수 있는 스터디를 놓치지 않게 되었어요. 지역을 고르면 해당 지역의 기본 스터디 장소로 바로 설정할 수도 있습니다. 이미 신청한 날짜는 신청 화면에 미리 선택된 상태로 보여지며, 해제하면 그 날짜의 신청이 취소됩니다. 그 밖에 매칭 시 참여 희망 시간대를 더 정확하게 반영하도록 개선했고, 매칭 범위 안의 신청 인원 수를 실제 기준에 맞게 표시하도록 수정했습니다.",
    date: "2026-09-10",
  },
  // {
  //   id: "135",
  //   title: "이번 주말 뭐하지? 고민 끝!",
  //   category: "행사",
  //   content:
  //     "채팅과 알림 기능을 개선해 안정적으로 소통할 수 있도록 보완했어요. 그리고 익명 커뮤니티를 본격적으로 출시했습니다. 이제 일상 공유, 질문·고민, 팀원 모집, 정보 공유, 홍보까지 모두 자유롭게 이용할 수 있으며, 모든 글은 익명이 보장됩니다. 부담 없이 가볍게 참여해보세요 🙂",
  //   date: "2026-03-24",
