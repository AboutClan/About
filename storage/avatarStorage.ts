export const AVATAR_COST = [0, 10, 30, 50, 70, 90, 110, 130, 150, 170, 190, 210, 300];
...
export const SPECIAL_AVATAR = [
  ...
  },
  {
    name: "펭귄 아바타(한정)",
    image:
      "https://studyabout.s3.ap-northeast-2.amazonaws.com/%EC%95%84%EB%B0%94%ED%83%80+%EC%95%84%EC%9D%B4%EC%BD%98/%EB%B3%B4%EB%9D%BC%ED%8E%AD%EA%B7%84_%EA%B8%B0%EB%B3%B8_%ED%88%AC%EB%AA%85.png",
  },
  {
    name: "삐약이 2(한정)",
    image:
