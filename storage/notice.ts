...
export const NOTICE_ARR: INoticeArr[] = [
  ...
  {
    id: "102",
    title: "번개 개설시 5000원 ~ 10000원 활동비 지원!!",
    category: "event",
    content:
  ...
  {
    id: "103",
    title: "동아리 확장 및 홍보 이벤트 (매번 2000원 + 치킨까지?)",
    category: "main",
    content:
      "여태까지 동아리 홍보를 안하고 있었는데요...! 이제 계획했던 준비들이 거의 다 끝나가서 확장을 시도합니다! 지역 또한 기존보다 3배 이상 확장되었어요! 에타에 홍보글을 올릴때 마다 2000원과 매주 치킨 기프티콘을 뿌립니다!",
    date: "2023-07-08",
  },
];
