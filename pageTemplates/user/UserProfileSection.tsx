...
import UserBenefitBanner from "@/pageTemplates/user/UserBenefitBanner";
import UserCollection from "@/pageTemplates/user/UserCollection2";
import UserPointBlock from "@/pageTemplates/user/UserPointBlock";
import UserProfile from "@/pageTemplates/user/UserProfile2";
import UserProfileBar from "@/pageTemplates/user/UserProfileBar";
import UserReviewBar from "@/pageTemplates/user/UserReviewBar";
import UserScoreGuideDrawer from "@/pageTemplates/user/UserScoreGuideDrawer";
import UserSocialGuideDrawer from "@/pageTemplates/user/UserSocialGuideDrawer";
import UserTicketDeductionNotice from "@/pageTemplates/user/UserTicketDeductionNotice";
